...
?><html>
    <head>
       <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
		...
		<div class="container-fluid" style="background-color: #333; padding: 10px;margin-top:50px">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form-horizental" style="width: 80%; margin: 0px auto;">
				        <div class="input-group">
                            ...
                            <span class="input-group-btn"><input type="submit" class="btn btn-success" name="submit"></span>
						</div>
				...
				<div class="col-md-3">
					<div class="row text-center" style="color: #aaa; font-size: 1.3em; padding-top: 20px; font-family: Halvetica;">
						...
						<div class="col-md-12 suport" onclick="location.href='policy.php';">Privacy Policy</div>
						<div class="col-md-12 suport" onclick="location.href='t_and_c.php';">Terms &amp; Conditions</div>
					</div>
