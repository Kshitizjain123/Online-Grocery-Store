    ...
    <div class="bs-example">
        <nav role="navigation" class="navbar navbar-inverse" style="padding: 20px; border-radius: 0px;">
            <div class="row container-fluid">
            	<div class="col-md-6">
            		<a href="../Index.php" class="navbar-brand"><i class="fa fa-globe"></i> Grocify</a>
            	</div>
            	<div class="col-md-6">
            		<a href="Logout.php" class="btn-link" style="font-size: 1.2em; text-decoration: none; float: right; margin-top:10px;"><i class="fa fa-sign-out" style="font-size: 22px;"></i> Log Out</a>
            	</div>
            </div>
        </nav>
    </div>
