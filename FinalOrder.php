...
<html>
	...
	<div class="container-fluid">
		<div class="row" style="background-color: #333; color: #aaa;">
			<div class="col-xs-6">
				<h2 class="text-left" style="cursor: pointer;" onclick="location.href='Index.php';">Grocify</h2>
			</div>
		...
		<div class="col-md-6">
			<?php
				...
				if($row = mysqli_fetch_array($result))
				{
					...
					echo "<h5 class='text-center'>Dear ".$row[0].", We will accept cash on delivery time.</h5>";
				}
			?>
		...
		<div class="col-xs-12 text-center">
			&copy; Copyright 2020. All rights reserved. Grocify.
		</div>
	</body>
...
if(isset($_SESSION['user']))
{
	if(isset($_POST['Submit']))
	{
		...
		$qry = "INSERT INTO orders(address,username,user_id,amount) VALUES ('".$addr."','".$row[0]."',".$_SESSION['user'].",".$grand_total.")";
		$fulldate = getdate(date("U"));
	    $sql = "INSERT INTO activity(activity, act_date) VALUES ('Some Products are purchased by ".$row[0]."','$fulldate[mday]/$fulldate[month]/$fulldate[year]');";
	    if(mysqli_query($con, $qry) and mysqli_query($con, $sql))
		{
			$_SESSION['ordr'] = mysqli_insert_id($con);
            echo '<script type="text/javascript">

          window.onload = function () { alert("Order Succesfully Placed"); }
